        ...
        'settings' => [
            'color' => [
                'palette' => [
                    [
                        'slug'  => 'primary',
                        'name'  => __('Primary', 'b2b-industrial'),
                        'color' => $primary,
                    ],
                    [
                        'slug'  => 'secondary',
                        'name'  => __('Secondary', 'b2b-industrial'),
                        'color' => $secondary,
                    ],
                    [
                        'slug'  => 'accent',
                        'name'  => __('Accent', 'b2b-industrial'),
                        'color' => $accent,
                    ],
                    [
                        'slug'  => 'surface',
                        'name'  => __('Surface', 'b2b-industrial'),
                        'color' => $surface,
                    ],
                    [
                        'slug'  => 'white',
                        'name'  => __('White', 'b2b-industrial'),
                        'color' => '#FFFFFF',
                    ],
                    [
                        'slug'  => 'body-text',
                        'name'  => __('Text', 'b2b-industrial'),
                        'color' => $text,
                    ],
                    [
                        'slug'  => 'muted',
                        'name'  => __('Muted', 'b2b-industrial'),
                        'color' => '#66736F',
                    ],
                    [
                        'slug'  => 'border',
                        'name'  => __('Border', 'b2b-industrial'),
                        'color' => '#DDE5E2',
                    ],
                    [
                        'slug'  => 'alert',
                        'name'  => __('Alert', 'b2b-industrial'),
                        'color' => '#B83A34',
                    ],
                    [
                        'slug'  => 'header-bg',
                        'name'  => __('Header Background', 'b2b-industrial'),
                        'color' => $header_bg,
                    ],
                    [
                        'slug'  => 'footer-bg',
                        'name'  => __('Footer Background', 'b2b-industrial'),
                        'color' => $footer_bg,
                    ],
                    [
                        'slug'  => 'hero-overlay',
                        'name'  => __('Hero Overlay', 'b2b-industrial'),
                        'color' => $overlay,
                    ],
                    [
                        'slug'  => 'black',
                        'name'  => __('Black', 'b2b-industrial'),
                        'color' => '#000000',
                    ],
                ],
            ],
